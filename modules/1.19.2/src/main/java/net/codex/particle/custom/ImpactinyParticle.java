...
public class ImpactinyParticle extends SpriteBillboardParticle {
    ...
    private static final float BASE_SCALE = 0.85f;        // base size multiplier
    ...
    public ImpactinyParticle(ClientWorld world,
        ...
        // reuse fields from given effect (same as your ground-splash)
    ...
    public void tick() {
        ...
        // keep particle visually static in world-space (same behaviour as your ground slam)
