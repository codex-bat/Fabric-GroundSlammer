...
public class ImpactParticle extends SpriteBillboardParticle {
    ...
    public void buildGeometry(VertexConsumer vc, Camera camera, float tickDelta) {
        ...
        final int argb = ((int) (this.alpha * fade * 255.0f) << 24)
                | (255 << 16)
                | (255 << 8)
                | 255;

        vc.vertex(x1, yBottom, z1, argb, u1, v1, 0, light, 0, 1, 0);
        vc.vertex(x2, yBottom, z1, argb, u2, v1, 0, light, 0, 1, 0);
        vc.vertex(x2, yBottom, z2, argb, u2, v2, 0, light, 0, 1, 0);
        vc.vertex(x1, yBottom, z2, argb, u1, v2, 0, light, 0, 1, 0);
