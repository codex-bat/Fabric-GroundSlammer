...
public class DirectedImpactParticle extends SpriteBillboardParticle {
    ...
    public void buildGeometry(VertexConsumer vc, Camera camera, float tickDelta) {
        ...
        final int argb = toArgb(this.red, this.green, this.blue, this.alpha * fade);

        vc.vertex(x0, y0, z0, argb, u1, v1, 0, light, 0, 1, 0);
        vc.vertex(x1, y1, z1, argb, u2, v1, 0, light, 0, 1, 0);
        vc.vertex(x2, y2, z2, argb, u2, v2, 0, light, 0, 1, 0);

        vc.vertex(x0, y0, z0, argb, u1, v1, 0, light, 0, 1, 0);
        vc.vertex(x2, y2, z2, argb, u2, v2, 0, light, 0, 1, 0);
        vc.vertex(x3, y3, z3, argb, u1, v2, 0, light, 0, 1, 0);
