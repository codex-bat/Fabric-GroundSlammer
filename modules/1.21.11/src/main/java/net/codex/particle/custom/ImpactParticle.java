...
public class ImpactParticle extends CuboidParticle {
    ...
    public void tick() {
        ...
        // Calculate fade from life progress
    ...
    public static final class Factory implements ParticleFactory<GroundSplashParticleEffect> {
        ...
        public Particle createParticle(GroundSplashParticleEffect effect,
            ...
            return new ImpactParticle(world, x, y, z, effect, this.spriteProvider, sprite);
        }
    }
}