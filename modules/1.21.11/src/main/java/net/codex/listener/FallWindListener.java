...
public final class FallWindListener {
    ...
    public static void register() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            boolean isFlying = player.getAbilities().flying || player.isGliding();
            ...
            if (windInstance != null) {
                ...
                windInstance.updatePosition(player.getSyncedPos());
    ...
    private static final class PlayerWindSound extends MovingSoundInstance {
        ...
        public PlayerWindSound(PlayerEntity player) {
            ...
            super(ModSounds.WIND, SoundCategory.AMBIENT, player.getEntityWorld().random);
            this.player = player;
            this.repeat = true;
            this.repeatDelay = 0;
            this.volume = baseVolume;
            // initialize position to player; engine will read these coordinates for attenuation
            Vec3d p = player.getSyncedPos();
            this.x = p.x;
            this.y = p.y;
            this.z = p.z;
        ...
        public void tick() {
            ...
            Vec3d p = this.player.getSyncedPos();
            this.x = p.x;
            this.y = p.y;
            this.z = p.z;
        }
